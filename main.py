...
def defence(char_name, char_class):
    ...
    if char_class == 'healer':
        a, b = 2, 5
    return f'{char_name} блокировал {10 + randint(a, b)} урона'

def special(char_name, char_class):
    ''' Special depend on class of gamer '''

    if char_class == 'warrior':
        a, b = 80, 25
        skill = f'Выносливость {a + b}'
    if char_class == 'mage':
        a, b = 5, 40
        skill = f'Атака {a + b}'
    if char_class == 'healer':
...
def start_training(char_name, char_class):
    ...
    print('чтобы блокировать атаку противника или special — чтобы использовать свою суперсилу.')
